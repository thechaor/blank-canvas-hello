    ...
    <header className="sticky top-0 z-50 border-b border-border/40 bg-background/90 backdrop-blur-xl transition-all">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div className="hidden items-center gap-3 md:flex">
          ...
          <Link
            to="/cart"
            className="relative flex h-9 w-9 items-center justify-center rounded-xl border border-border/40 bg-card/40 text-foreground transition-all hover:bg-accent hover:border-primary/30"
