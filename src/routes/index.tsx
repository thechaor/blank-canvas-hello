      ...
      <section className="relative flex min-h-[85vh] items-center justify-center overflow-hidden sm:min-h-[90vh]">
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-4 py-16 text-center sm:px-6 sm:py-20 lg:px-8">
          ...
          <h1
            ...
            style={{ textShadow: '0 0 12px rgba(255,255,255,0.58), 0 0 24px rgba(255,255,255,0.36)' }}
          >
            Colecione as cartas
            <span
          ...
          <p
            ...
            style={{ textShadow: '0 0 8px rgba(255,255,255,0.43), 0 0 16px rgba(255,255,255,0.22)' }}
          >
          ...
          <div className="mt-12 grid grid-cols-3 gap-4 border-t border-border/60 pt-8 sm:mt-16 sm:gap-8">
            <div>
              <p className="text-2xl font-bold text-white sm:text-3xl" style={{ textShadow: '0 0 8px rgba(255,255,255,0.43)' }}>500+</p>
              <p className="mt-1 text-xs text-white/70 sm:text-sm">Cartas disponíveis</p>
            </div>
            <div>
              <p className="text-2xl font-bold text-white sm:text-3xl" style={{ textShadow: '0 0 8px rgba(255,255,255,0.43)' }}>10k+</p>
              <p className="mt-1 text-xs text-white/70 sm:text-sm">Colecionadores</p>
            </div>
            <div>
              <p className="text-2xl font-bold text-white sm:text-3xl" style={{ textShadow: '0 0 8px rgba(255,255,255,0.43)' }}>4.9</p>
